...
_tls_ctx: ?*uws.SocketContext = null,
...
pub fn upgradeToTLS(this: *MySQLConnection) !void {
    if (this._socket == .SocketTCP) {
        const new_socket = this._socket.SocketTCP.socket.connected.upgrade(this._tls_ctx.?, this._tls_config.server_name) orelse {
...
pub fn doHandshake(this: *MySQLConnection, success: i32, ssl_error: uws.us_bun_verify_error_t) !bool {
    ...
    if (handshake_success) {
        ...
        if (this._tls_config.reject_unauthorized != 0) {
            ...
            // https://github.com/porsager/postgres/blob/6ec85a432b17661ccacbdf7f765c651e88969d36/src/connection.js_L272-L279
